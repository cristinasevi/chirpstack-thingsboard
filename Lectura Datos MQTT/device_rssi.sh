...
curl_command="curl -s -X GET --header \"Accept: application/json\" --header \"Grpc-Metadata-Authorization: Bearer {{token_chirpstack}}\" \"http://localhost:8080/api/devices/{{dev_eui}}/frames\""
